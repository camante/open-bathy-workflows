...
from pipeline.river_linear.river_linear_contract import FINAL_USER_DEM_RELATIVE_PATH, artifact_name


@dataclass(frozen=True)
class RiverLinearPaths:
    root: Path
    contract_dir: Path
...
def build_river_linear_paths(out_dir: str | Path, *, write_diagnostics: bool = True, write_core_receipts: bool = True) -> RiverLinearPaths:
...
__all__ = ["RiverLinearPaths", "build_river_linear_paths"]
