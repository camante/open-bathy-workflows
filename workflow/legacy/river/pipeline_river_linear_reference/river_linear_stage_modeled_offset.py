...
from pipeline.river_linear.river_linear_modeled_offset_logic import build_modeled_offset_points
from pipeline.river_linear.river_linear_stage_observed_offset import ObservedOffsetStageResult
from pipeline.river_linear.river_linear_stage_wse_proxy import WSEProxyStageResult
from pipeline.river_linear.river_linear_validation import validate_modeled_offset_points_gpkg
...
def run_modeled_offset_stage(
    ...
    if flat_failures:
        ...
        raise RuntimeError(
            'river_linear_modeled_offset_construction_flatness_fail:'
