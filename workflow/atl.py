...
def load_extra_xyz_points(xyz_files: List[str], crs: str, aoi_str: str) -> pd.DataFrame:
    """Backward-compatible wrapper for shared support-point loading."""
    from support_points import load_extra_xyz_points as _load_extra_xyz_points

    return _load_extra_xyz_points(xyz_files, crs=crs, aoi_str=aoi_str)
