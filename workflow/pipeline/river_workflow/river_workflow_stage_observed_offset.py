...
from pipeline.river_workflow.river_workflow_stage_authoritative_bed import AuthoritativeBedStageResult
from pipeline.river_workflow.river_workflow_stage_wse_proxy import WSEProxyStageResult
from pipeline.river_workflow.river_workflow_validation import validate_observed_offset_points_gpkg
from pipeline.river_workflow.river_workflow_stage_helpers import validate_observed_offsets
...
def run_observed_offset_stage(
    ...
    if not validation.get('valid'):
        ...
        raise RuntimeError(f'river_workflow_observed_offset_invalid:{validation}:warnings={warnings}:audits={current_path_audit},{qc_audit}')
