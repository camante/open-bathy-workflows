...
from pipeline.river_workflow.river_workflow_stage_helpers import read_network_lines
...
def fingerprint_authoritative_source(ctx: Any) -> str | None:
    ...
    canonical authoritative rasters separately in river_workflow_cache.py.
    """
