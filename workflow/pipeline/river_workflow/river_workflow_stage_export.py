...
from pipeline.river_workflow.river_workflow_export_logic import build_take_mask, stage_mask_handoff, subset_binary_mask_to_template_exact, subset_float_raster_to_template_exact
...
from pipeline.river_workflow.river_workflow_validation import validate_background_covers_measured_only, validate_mask_raster, validate_support_mask_matches_measured_only, validate_surface_raster, validate_take_mask_raster
...
def _canonical_export_sources(ctx: RiverWorkflowContext) -> tuple[Path | None, Path | None, Path | None]:
