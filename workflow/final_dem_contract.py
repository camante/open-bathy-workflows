...
def build_final_dem_contract_summary(report: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "invariants": {
            ...
            "legacy_candidate_gap_only_backstop": True,
        },
        "route_cleanup": {
            "source_candidate_mode": candidate_generation.get("mode"),
            "legacy_candidate_role": backstop_policy.get("legacy_candidate_role", "gap_only_backstop"),
            ...
            "legacy_backstop_used": bool(legacy_fallback_pixels > 0),
        },
        "guidance_roles": {
